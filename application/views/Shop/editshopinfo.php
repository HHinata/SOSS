                        ...
                        <div class="Input__inputGroup___2_TNL">
                            <label class="Input__label___1zkjm undefined Input__isTwoLine___1qSB9">
                                 <span class="Input__labelText___3690B">
                                    <font style="vertical-align: inherit;">
                                        <font style="vertical-align: inherit;">商铺名称</font>
                                    </font>
                                 </span>
                                <input type="text" class="Input__textInput___13McV" value="" name="sname"></label>
                        </div>
                        <div class="Input__inputGroup___2_TNL">
                            <label class="Input__label___1zkjm undefined Input__isTwoLine___1qSB9">
                                 <span class="Input__labelText___3690B">
...
<script>
    function login() {
        document.loginForm.action = "EditShopInfo?flag=1&usertype=2&uid=<?php echo $uid ?>";
