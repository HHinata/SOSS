                    ...
                    <div ng-class="styles.container" mc-click="$event.stopPropagation()" class="_2zr0iYIKVbpdSwEMCUn83Q-style-container">
                        <div ng-class="styles.inner" class="_1Pe7GdQbdUNvrHqqjaEkWP-style-inner">
                            <div ng-class="styles.group" class="_2UigEaYqg_TEE1K979TvOl-style-group">
                                <div ng-class="styles.title" class="_2qB5iACcWxNybtA6D2bYR7-style-title">餐厅名称</div>
                            ...
                            <div ng-class="styles.group" class="_2UigEaYqg_TEE1K979TvOl-style-group">
                                <div ng-class="styles.title" class="_2qB5iACcWxNybtA6D2bYR7-style-title">订单信息</div>
                                <div mc-modal-me-item="" text="查看和修改" on-click-item="ctrl.openModalBinding" href="/UserList?flag=1&gid=<?php echo $shop_info['sid']?>" class="ng-isolate-scope">
                                    <a ng-class="styles.item" mc-click="onClick($event)" ng-href="" href="/UserList?flag=1&gid=<?php echo $shop_info['sid']?>" class="jJ_UGsU2MxEp9-XuX_b7U-style-item">
                                        <span class="ng-binding">查看和修改</span>
                            ...
                            <div ng-class="styles.group" class="_2UigEaYqg_TEE1K979TvOl-style-group">
                                <div ng-class="styles.title" class="_2qB5iACcWxNybtA6D2bYR7-style-title">菜品信息</div>
                                <div mc-modal-me-item="" text="查看和修改" on-click-item="ctrl.openModalBinding" href="/Commoditys?flag=1&sid=<?php echo $shop_info['sid']?>" class="ng-isolate-scope">
                                    <a ng-class="styles.item" mc-click="onClick($event)" ng-href="" href="/Commoditys?flag=1&sid=<?php echo $shop_info['sid']?>" class="jJ_UGsU2MxEp9-XuX_b7U-style-item">
                                        <span class="ng-binding">查看和修改</span>
                                        <i ng-class="['icon',  customClass, iconClass]" mc-icon="" class-name="_2zn6BlloQejehRAwde1wBE-style-icon" which="arrow-right-digital-card" class="ng-isolate-scope icon  icon-arrow-right-digital-card _2zn6BlloQejehRAwde1wBE-style-icon"></i>
                                    </a>
                                </div>
                            ...
                            <div ng-class="styles.group" class="_2UigEaYqg_TEE1K979TvOl-style-group">
                                <div ng-class="styles.title" class="_2qB5iACcWxNybtA6D2bYR7-style-title">合作企业</div>
                                <div mc-modal-me-item="" text="查看和修改" href="/GroupList?flag=1&sid=<?php echo $shop_info['sid']?>" on-click-item="ctrl.openModalBinding" class="ng-isolate-scope">
                                    <a ng-class="styles.item"  ng-href="" href="/GroupList?flag=1&sid=<?php echo $shop_info['sid']?>" class="jJ_UGsU2MxEp9-XuX_b7U-style-item">
                                        <span class="ng-binding">查看和修改</span>
                                        <i ng-class="['icon',  customClass, iconClass]" mc-icon="" class-name="_2zn6BlloQejehRAwde1wBE-style-icon" which="arrow-right-digital-card" class="ng-isolate-scope icon  icon-arrow-right-digital-card _2zn6BlloQejehRAwde1wBE-style-icon"></i>
                                    </a>
                                </div>
                            ...
                            <div ng-class="styles.group" class="_2UigEaYqg_TEE1K979TvOl-style-group">
                                <div ng-class="styles.title" class="_2qB5iACcWxNybtA6D2bYR7-style-title">设置</div>
                                <div ng-if="!ctrl.e.isMobile" mc-modal-me-item="" text="修改信息" href="/EditShopInfo?sid<?php echo $shop_info['sid']?>" class="ng-scope ng-isolate-scope">
                                    <a ng-class="styles.item" ng-href="" href="/EditShopInfo?sid=<?php echo $shop_info['sid']?>" class="jJ_UGsU2MxEp9-XuX_b7U-style-item">
