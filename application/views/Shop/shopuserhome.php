    ...
    <div class="_3_ezOQfol5ICPsaEsgqgEI-style-container mc-animation-fade" mc-nav-directive="">
      ...
      overflow: isOpen ? 'visible' : 'hidden'
            ...
            [styles.active]: meal === ctrl.meal.current
                                        ...
                                        <a ng-href="/Welcome?usertype=2&date=0&uid=<?php echo $uid?>" ng-class="styles.link" href="/Welcome?usertype=2&date=0&uid=<?php echo $uid?>" class="_1FtPiX9ThRadyw-1Pi_FkT-style-link">
                                            <span class="_YvHHUKePRPNyHOMAZBY_-style-targetTime">18:30</span>
                                            <div class="_2cvy9glTa02FB4VfYHx2LY-style-name">企业付晚餐</div>
            ...
            [styles.pressed]: pressBatch
              ...
              'icon-waiter_icon_pressed': actionMenuCtrl.isOn()
               ...
               [styles.pressed]: pressNotification
                ...
                <div ng-class="styles.user"  onclick="window.location.href='UserInfo?uid=<?php echo $uid?>&usertype=2&sid=<?php echo $sid?>';" class="_2aFVDIPMLKYnkv0x2vi3dW-style-user">
    ...
    <div class="_1KNiA28qlRm4LucsDNab0Z-style-restSection mc-animation-fade" mc-re-directive="">
        ...
        <div class="_37iJcSDIbh5G-vvTkAaGZu-style-header js-fixed">
            ...
            <div class="_2J_4A2wKM94FvRGZ6HNej-style-mealTitle" ng-if="!ctrl.isSearchFormOn">
                <h3 class="ng-binding"><?php echo $date[0]?> 16:30</h3>
                <span class="_3r-TbkQw68v7mdhVe01ZSX-style-corpName"><?php echo $shop_info['sname']?></span>
    ...
    <div ng-class="styles.container" mc-dish-directive="" ng-if="ctrl.isShowDish" class="ng-scope _1po2JRN2PMhBYoDFMakreW-style-container" id="three_list">
        ...
        <div class="_3kfuIgYLEKNcaG73pZkDlk-style-header" mc-section-head="" status="ctrl.status">
            ...
            <div class="_3xfp6SHIapi2SZOEh0R8t3-style-restName mc-animation-fade" ng-if="ctrl.dish.restaurant.name" style="opacity: 1;">
                <span class="f19zmoxFFn21rJGNW9mFY-style-restNameText"><?php echo $shop_info['sname'] ?></span>
...
<script>
    function three_list_mark(three_list_flag) {
        var a = document.createElement("div");
        a.setAttributeNode(add("ng-if", "!ctrl.isLoading"));
        a.setAttributeNode(add("class", "_2ABZZGf8ZDa_pczpgG-EPp-style-cartWrapper"));

        var b = document.createElement("div");
        b.setAttributeNode(add("class","_3SOdkEVVxiddvqcvtUgpy2-style-cart mc-animation-slide-bottom"));
        b.setAttributeNode(add("mc-click", "ctrl.toggleCart()"));
        b.setAttributeNode(add("ng-if","ctrl.isCartShow"));
        b.setAttributeNode(add("style","margin-bottom: 0px; margin-top: 0px;"));

        var c = document.createElement("div");
        c.setAttributeNode(add("class", "_3zUKevSrcZdZ9UHSueE0_G-style-cartInner"));

        var d = document.createElement("div");
        d.setAttributeNode(add("class", "_2770gFSu7OKtvUBRvizyCu-style-cartBlock"));

        var e = document.createElement("span");
        e.setAttributeNode(add("class", "btn ng-scope _2v9yYDcnyC3Y4-HEFjyXkZ-style-cartOrder"));
        e.setAttributeNode(add("mc-class","{[styles.cartOrder]: true,[styles.ordering]: ctrl.isOrdering,[styles.disabled]: ctrl.cart.count < 1}"));
        e.setAttributeNode(add("ng-if","!ctrl.isCartOpen"));

        var f = document.createElement("span");
        f.setAttributeNode(add("class", "ng-scope"));
        f.setAttributeNode(add("ng-if","!ctrl.isOrdering"));
        f.setAttributeNode(add("onclick","window.location.href='EditCommodity?uid=<?php echo $uid?>&usertype=2&cid=<?php echo $cid?>&sid=<?php echo $sid?>';"));
        var node = document.createTextNode('修改');
        f.appendChild(node);

        var e1 = document.createElement("span");
        e1.setAttributeNode(add("class", "btn ng-scope _2v9yYDcnyC3Y4-HEFjyXkZ-style-cartOrder"));
        e1.setAttributeNode(add("mc-class","{[styles.cartOrder]: true,[styles.ordering]: ctrl.isOrdering,[styles.disabled]: ctrl.cart.count < 1}"));
        e1.setAttributeNode(add("ng-if","!ctrl.isCartOpen"));
        var f1 = document.createElement("span");
        f1.setAttributeNode(add("class", "ng-scope"));
        f1.setAttributeNode(add("ng-if","!ctrl.isOrdering"));
        f1.setAttributeNode(add("onclick","window.location.href='DeleteCommodity?uid=<?php echo $uid?>&usertype=2&cid=<?php echo $cid?>&sid=<?php echo $sid?>';"));
        var node1 = document.createTextNode('删除');
        f1.appendChild(node1);

        var e2 = document.createElement("span");
        e2.setAttributeNode(add("class", "btn ng-scope _2v9yYDcnyC3Y4-HEFjyXkZ-style-cartOrder"));
        e2.setAttributeNode(add("mc-class","{[styles.cartOrder]: true,[styles.ordering]: ctrl.isOrdering,[styles.disabled]: ctrl.cart.count < 1}"));
        e2.setAttributeNode(add("ng-if","!ctrl.isCartOpen"));
        var f2 = document.createElement("span");
        f2.setAttributeNode(add("class", "ng-scope"));
        f2.setAttributeNode(add("ng-if","!ctrl.isOrdering"));
        var node2 = document.createTextNode('下架');
        var node21 = document.createTextNode('上架');
        if(three_list_flag == 1) {
            f2.setAttributeNode(add("onclick","window.location.href='OffCommodity?uid=<?php echo $uid?>&usertype=2&cid=<?php echo $cid?>&sid=<?php echo $sid?>';"));
            f2.appendChild(node2);
        }else{
            f2.setAttributeNode(add("onclick","window.location.href='OnCommodity?uid=<?php echo $uid?>&usertype=2&cid=<?php echo $cid?>&sid=<?php echo $sid?>';"));
            f2.appendChild(node21);
        }
        ...
        var element = document.getElementById("three_list");
        element.appendChild(a);
    }
    function three_list_ord_mark(oid) {
        var a = document.createElement("div");
        a.setAttributeNode(add("ng-if", "!ctrl.isLoading"));
        a.setAttributeNode(add("class", "_2ABZZGf8ZDa_pczpgG-EPp-style-cartWrapper"));
        ...
        f.setAttributeNode(add("class", "ng-scope"));
        f.setAttributeNode(add("ng-if","!ctrl.isOrdering"));
        f.setAttributeNode(add("onclick","window.location.href='AcceptOrder?uid=<?php echo $uid?>&usertype=2&oid="+oid+"&sid=<?php echo $sid?>';"));
        var node = document.createTextNode('接单');
        f.appendChild(node);
    ...
    function chakandingdan() {
        ...
        a.setAttributeNode(add("class", "F9ey8JgI2IoqPcogOQFwt-style-rest mc-animation-slide <?php echo $ckddxz?>"));
        ...
        b.setAttributeNode(add("href", "/Welcome?flag=1&date=<?php echo $date_num?>&uid=<?php echo $uid?>&usertype=2&orderflag=1"));
    ...
    function chakanqiye() {
        var a = document.createElement("li");
        a.setAttributeNode(add("ng-if", "ctrl.currentMeal.order"));
        a.setAttributeNode(add("class", "F9ey8JgI2IoqPcogOQFwt-style-rest mc-animation-slide <?php echo $ckqyxz?>"));
        a.setAttributeNode(add("ng-init", "isMouseOn = false;"));
        a.setAttributeNode(add("ng-mouseover", "isMouseOn = true;"));
        a.setAttributeNode(add("ng-mouseout", "isMouseOn = false;"));
        a.setAttributeNode(add("mc-class", "{[styles.active]: ctrl.isOrderActive }"));
        ...
        var b = document.createElement("a");
        b.setAttributeNode(add("ng-href", "!ctrl.e.isMobile"));
        b.setAttributeNode(add("href", "/Welcome?flag=1&date=<?php echo $date_num?>&uid=<?php echo $uid?>&usertype=2&groupflag=1"));


        var c = document.createElement("div");
        c.setAttributeNode(add("class", "_3uNy7RgCOUcfFu6au1W54_-style-restInner"));
        var d = document.createElement("span");
        var node = document.createTextNode('合作企业');
        d.appendChild(node);
    ...
    function addcommodity() {
        ...
        var b = document.createElement("a");
        b.setAttributeNode(add("ng-href", "!ctrl.e.isMobile"));
        b.setAttributeNode(add("href", "/AddCommodity?uid=<?php echo $uid?>&usertype=2&sid=<?php echo $sid?>"));
        ...
        var d = document.createElement("span");
        var node = document.createTextNode('添加菜品');
        d.appendChild(node);
    ...
    function addshopgroup() {
        ...
        var b = document.createElement("a");
        b.setAttributeNode(add("ng-href", "!ctrl.e.isMobile"));
        b.setAttributeNode(add("href", "/AddShopGroup?uid=<?php echo $uid?>&usertype=2&sid=<?php echo $sid?>"));
        ...
        var d = document.createElement("span");
        var node = document.createTextNode('添加企业');
        d.appendChild(node);
    ...
    function buildShop(shop) {
        ...
        var b = document.createElement("a");
        b.setAttributeNode(add("ng-href", "/Welcome?flag=1&date=<?php echo $date_num?>&uid=<?php echo $uid?>&usertype=2"));
        b.setAttributeNode(add("href", "/Welcome?flag=1&date=<?php echo $date_num?>&uid=<?php echo $uid?>&usertype=2"));
    ...
    function buildCommodity(commodity,num)
    {
        var a = document.createElement("li");
        ...
        a.setAttributeNode(add("ng-mouseover", "isMouseOver = true;"));
        a.setAttributeNode(add("ng-mouseout", "isMouseOver = false;"));
        a.setAttributeNode(add("ng-if", "dish.name"));
        a.setAttributeNode(add("ng-repeat", "dish in section.dishes track by $index"));
        a.setAttributeNode(add("class", "ng-scope _16JFh_4mqlSffOpyj-kpiZ-style-dish "+commodity['huise']+' '+commodity['xuanzhong']));
        ...
        c.setAttributeNode(add("onclick","window.location.href='/Welcome?flag=1&date=<?php echo $date_num?>&uid=<?php echo $uid?>&usertype=2&commodity_num="+num+"';"));
        ...
        var node1 = document.createTextNode(commodity['cname']);
        l.appendChild(node1);
        var m = document.createElement("div");
        m.setAttributeNode(add("class", "_1HwOunLJd2-n_KC65PCLQ1-style-dishSubtitle"));
        var node2 = document.createTextNode(commodity['describes']);
        m.appendChild(node2);
    ...
    function buildOrder(order,num)
    {
        ...
        a.setAttributeNode(add("ng-if", "dish.name"));
        a.setAttributeNode(add("ng-repeat", "dish in section.dishes track by $index"));
        a.setAttributeNode(add("class", "ng-scope _16JFh_4mqlSffOpyj-kpiZ-style-dish "+order['huise']+' '+order['xuanzhong']));
        ...
        if(order['flag'] == 0) {
            c.setAttributeNode(add("onclick", "window.location.href='/Welcome?orderflag=1&flag=1&date=<?php echo $date_num?>&uid=<?php echo $uid?>&usertype=2&order_num=" + num + "';"));
        }
        ...
        var l = document.createElement("div");
        l.setAttributeNode(add("class", "k830dcw3hnfrFruRRJShf-style-dishTitle"));
        var node1 = document.createTextNode(order['cname']);
        l.appendChild(node1);
        var m = document.createElement("div");
        m.setAttributeNode(add("class", "_1HwOunLJd2-n_KC65PCLQ1-style-dishSubtitle"));
        var node2 = document.createTextNode(order['address']);
        m.appendChild(node2);
        var n = document.createElement("div");
        n.setAttributeNode(add("class", "_2E1I0DVW20nub3sewfo33b-style-dishFav ng-hide"));
        n.setAttributeNode(add("ng-show", "ctrl.checkFavourite(restaurant.id, dish)"));
        ...
        r.setAttributeNode(add("class", "_1XdGI6FaEB_-Y_HzjRuy8L-style-dishFree WYUX1iwW0a7mlumZV6n0H-style-dishPrice"));
        r.setAttributeNode(add("ng-show", "ctrl.currentMeal.free"));
        var node3 = document.createTextNode(order['num']);
        r.appendChild(node3);
        var s = document.createElement("div");
        s.setAttributeNode(add("class", "l4v0hBmwjNECjhQpsgYG2-style-dishCount"));
        var t = document.createElement("div");
    ...
    function buildGroup(group,num)
    {
        ...
        a.setAttributeNode(add("ng-if", "dish.name"));
        a.setAttributeNode(add("ng-repeat", "dish in section.dishes track by $index"));
        a.setAttributeNode(add("class", "ng-scope _16JFh_4mqlSffOpyj-kpiZ-style-dish "+group['huise']+' '+group['xuanzhong']));
        ...
        var l = document.createElement("div");
        l.setAttributeNode(add("class", "k830dcw3hnfrFruRRJShf-style-dishTitle"));
        var node1 = document.createTextNode(group['gname']);
        l.appendChild(node1);
        var m = document.createElement("div");
        m.setAttributeNode(add("class", "_1HwOunLJd2-n_KC65PCLQ1-style-dishSubtitle"));
        var node2 = document.createTextNode(group['address']);
        m.appendChild(node2);
        var n = document.createElement("div");
        n.setAttributeNode(add("class", "_2E1I0DVW20nub3sewfo33b-style-dishFav ng-hide"));
        n.setAttributeNode(add("ng-show", "ctrl.checkFavourite(restaurant.id, dish)"));
        ...
        r.setAttributeNode(add("class", "_1XdGI6FaEB_-Y_HzjRuy8L-style-dishFree WYUX1iwW0a7mlumZV6n0H-style-dishPrice"));
        r.setAttributeNode(add("ng-show", "ctrl.currentMeal.free"));
        var node3 = document.createTextNode(group['price']);
        r.appendChild(node3);
        var s = document.createElement("div");
        s.setAttributeNode(add("class", "l4v0hBmwjNECjhQpsgYG2-style-dishCount"));
        var t = document.createElement("div");
    ...
    var addcoflag = <?php echo $addcommodity?>;
    if(dingdanflag){
        chakandingdan();
    }
    chakanqiye();
    ...
    addshopgroup();
    var shop = <?php echo json_encode($shop_info)?>;
    buildShop(shop);
    var co_sum = <?php echo count($commoditys_info)?>;
    var commoditys = <?php echo json_encode($commoditys_info)?>;
    for(var i = 0 ; i < co_sum ; i ++){
        buildCommodity(commoditys[i],i);
    }

    var order_sum = <?php echo count($orders_info)?>;
    var orders = <?php echo json_encode($orders_info)?>;
    for(var i = 0 ; i < order_sum ; i ++){
        buildOrder(orders[i],i);
    }

    var group_sum = <?php echo count($groups_info)?>;
    var groups = <?php echo json_encode($groups_info)?>;
    for(var i =0 ;i<group_sum ;i++){
        buildGroup(groups[i],i);
    }

    var three_list_flag = <?php echo $three_list_mark?>;
    if(three_list_flag != 0){
        three_list_mark(three_list_flag);
    }
    var three_list_ord_flag = <?php echo $three_list_ord_mark?>;
    if(three_list_ord_flag != -1){
        three_list_ord_mark(orders[three_list_ord_flag]['oid']);
    }
</script>
</body></html>