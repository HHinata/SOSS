                    ...
                    <div ng-class="styles.container" mc-click="$event.stopPropagation()" class="_2zr0iYIKVbpdSwEMCUn83Q-style-container">
                        <div ng-class="styles.inner" class="_1Pe7GdQbdUNvrHqqjaEkWP-style-inner">
                            ...
                            <div ng-class="styles.group" class="_2UigEaYqg_TEE1K979TvOl-style-group">
                                ...
                                <div mc-modal-me-item="" text="修改信息" on-click-item="ctrl.openModalBinding" href="/EditGroupInfo?uid=<?php echo $uid ?>&usertype=3" class="ng-isolate-scope">
                                    <a ng-class="styles.item" mc-click="onClick($event)" ng-href="" href="/EditGroupInfo?uid=<?php echo $uid ?>&usertype=3" class="jJ_UGsU2MxEp9-XuX_b7U-style-item">
