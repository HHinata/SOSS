    ...
    <div class="_3_ezOQfol5ICPsaEsgqgEI-style-container mc-animation-fade" mc-nav-directive="">
      ...
      overflow: isOpen ? 'visible' : 'hidden'
            ...
            [styles.active]: meal === ctrl.meal.current
                                        ...
                                        <a ng-href="/Welcome?usertype=1&date=0&uid=<?php echo $uid?>" ng-class="styles.link" href="/Welcome?usertype=1&date=0&uid=<?php echo $uid?>" class="_1FtPiX9ThRadyw-1Pi_FkT-style-link">
            ...
            [styles.active]: meal === ctrl.meal.current
                                        ...
                                        <a ng-href="/Welcome?usertype=1&date=1&uid=<?php echo $uid?>" ng-class="styles.link" href="/Welcome?usertype=1&date=1&uid=<?php echo $uid?>" class="_1FtPiX9ThRadyw-1Pi_FkT-style-link">
                                            <span class="_YvHHUKePRPNyHOMAZBY_-style-targetTime">18:30</span>
                                            <div class="_2cvy9glTa02FB4VfYHx2LY-style-name">企业付<?php echo $address; ?>晚餐</div>
                                            <!-- ngIf: meal.isAvailable && ctrl.checkMealInSearch(meal) -->
                                        </a>
            ...
            [styles.active]: meal === ctrl.meal.current
                                        ...
                                        <a ng-href="/Welcome?usertype=1&date=2&uid=<?php echo $uid?>" ng-class="styles.link" href="/Welcome?usertype=1&date=2&uid=<?php echo $uid?>" class="_1FtPiX9ThRadyw-1Pi_FkT-style-link">
                                            <span class="_YvHHUKePRPNyHOMAZBY_-style-targetTime">18:30</span>
                                            <div class="_2cvy9glTa02FB4VfYHx2LY-style-name">企业付<?php echo $address; ?>晚餐</div>
                                            <!-- ngIf: meal.isAvailable && ctrl.checkMealInSearch(meal) -->
                                        </a>
            ...
            [styles.active]: meal === ctrl.meal.current
                                        ...
                                        <a ng-href="/Welcome?usertype=1&date=3&uid=<?php echo $uid?>" ng-class="styles.link" href="/Welcome?usertype=1&date=3&uid=<?php echo $uid?>" class="_1FtPiX9ThRadyw-1Pi_FkT-style-link">
                                            <span class="_YvHHUKePRPNyHOMAZBY_-style-targetTime">18:30</span>
                                            <div class="_2cvy9glTa02FB4VfYHx2LY-style-name">企业付<?php echo $address; ?>晚餐</div>
                                            <!-- ngIf: meal.isAvailable && ctrl.checkMealInSearch(meal) -->
                                        </a>
            ...
            [styles.active]: meal === ctrl.meal.current
                                        ...
                                        <a ng-href="/Welcome?usertype=1&date=4&uid=<?php echo $uid?>" ng-class="styles.link" href="/Welcome?usertype=1&date=4&uid=<?php echo $uid?>" class="_1FtPiX9ThRadyw-1Pi_FkT-style-link">
                                            <span class="_YvHHUKePRPNyHOMAZBY_-style-targetTime">18:30</span>
                                            <div class="_2cvy9glTa02FB4VfYHx2LY-style-name">企业付<?php echo $address; ?>晚餐</div>
                                            <!-- ngIf: meal.isAvailable && ctrl.checkMealInSearch(meal) -->
                                        </a>
            ...
            [styles.active]: meal === ctrl.meal.current
                                        ...
                                        <a ng-href="/Welcome?usertype=1&date=5&uid=<?php echo $uid?>" ng-class="styles.link" href="/Welcome?usertype=1&date=5&uid=<?php echo $uid?>" class="_1FtPiX9ThRadyw-1Pi_FkT-style-link">
                                            <span class="_YvHHUKePRPNyHOMAZBY_-style-targetTime">18:30</span>
                                            <div class="_2cvy9glTa02FB4VfYHx2LY-style-name">企业付<?php echo $address; ?>晚餐</div>
                                            <!-- ngIf: meal.isAvailable && ctrl.checkMealInSearch(meal) -->
                                        </a>
            ...
            [styles.active]: meal === ctrl.meal.current
                                        ...
                                        <a ng-href="/Welcome?usertype=1&date=6&uid=<?php echo $uid?>" ng-class="styles.link" href="/Welcome?usertype=1&date=6&uid=<?php echo $uid?>" class="_1FtPiX9ThRadyw-1Pi_FkT-style-link">
                                            <span class="_YvHHUKePRPNyHOMAZBY_-style-targetTime">18:30</span>
                                            <div class="_2cvy9glTa02FB4VfYHx2LY-style-name">企业付<?php echo $address; ?>晚餐</div>
                                            <!-- ngIf: meal.isAvailable && ctrl.checkMealInSearch(meal) -->
                                        </a>
    ...
    <div ng-class="styles.container" mc-dish-directive="" ng-if="ctrl.isShowDish" class="ng-scope _1po2JRN2PMhBYoDFMakreW-style-container" id="three_list">
        ...
        <div class="_3kfuIgYLEKNcaG73pZkDlk-style-header" mc-section-head="" status="ctrl.status">
            ...
            <div class="_3xfp6SHIapi2SZOEh0R8t3-style-restName mc-animation-fade" ng-if="ctrl.dish.restaurant.name" style="opacity: 1;">
                <span class="f19zmoxFFn21rJGNW9mFY-style-restNameText"><?php echo $three_list_top_top ?></span>
...
<script>
    function three_list_mark(three_list_flag) {
        ...
        f.setAttributeNode(add("onclick","window.location.href='CreateOrder?uid=<?php echo $uid?>&usertype=1&cid=<?php echo $cid?>&sid=<?php echo $sid?>';"));
        var node = document.createTextNode('下单');
        f.appendChild(node);
    ...
    function chakandingdan() {
        ...
        b.setAttributeNode(add("href", "/Welcome?flag=1&date=<?php echo $date_num?>&uid=<?php echo $uid?>&usertype=1&ckddxzflag=1"));
    ...
    function buildCommodity(commodity,num)
    {
        ...
        if(commodity['huise'] == '') {
            c.setAttributeNode(add("onclick", "window.location.href='/Welcome?flag=1&date=<?php echo $date_num?>&uid=<?php echo $uid?>&usertype=1&commodity_num=" + num + "';"));
        }
