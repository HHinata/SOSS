          ...
          <font style="vertical-align: inherit;">
            ...
            <span>
              ...
              <font style="vertical-align: inherit;">
                ...
                <!-- react-text: 11 -->
              <font style="vertical-align: inherit;">
                <font style="vertical-align: inherit;">请先输入添加的菜品信息</font></font>
                <!-- /react-text --></span>
          </span>
                </div>
            </header>
                ...
                <div class="Login__container___FL5lV">
                    <form name="loginForm" role="form" action="welcome" method="post">
                        <div class="Login__header___12Rnk">
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">添加菜品</font>
                            </font>
                        </div>
...
<script>
    function login() {
        document.loginForm.action = "AddCommodity?flag=1&uid=<?php echo $uid?>&usertype=<?php echo $usertype?>&sid=<?php echo $sid?>";
