    ...
    <div ng-class="styles.inner" class="_3Hwu_2GSDIciwZ-e4opE4y-style-inner" style="margin-top: 0px;">
        <div ng-class="styles.header" ng-show="title" class="_3_wSuLB2xzf6CLU1pfE3Z1-style-header">
            <div ng-class="styles.headerInner" class="ward56HhCdk0GZ-1MTcvO-style-headerInner">
                <span ng-class="styles.title" class="ng-binding">菜品信息</span>
            </div>
        </div>
                ...
                <div ng-class="styles.block" class="_3nBaXV2aEsEJA2h2_HVAEx-style-block">
                    <div ng-class="styles.container" mc-click="$event.stopPropagation()" class="_2zr0iYIKVbpdSwEMCUn83Q-style-container">
                        <div id="xxx" ng-class="styles.inner" class="_1Pe7GdQbdUNvrHqqjaEkWP-style-inner">
                            ...
                            <div ng-class="styles.group" class="_2UigEaYqg_TEE1K979TvOl-style-group">
                                <div ng-if="!ctrl.e.isMobile" mc-modal-me-item="" text="添加菜品" href="/AddCommodity?sid=<?php echo $sid?>" class="ng-scope ng-isolate-scope">
                                    <a ng-class="styles.item" ng-href="/AddCommodity?sid=<?php echo $sid?>" href="/AddCommodity?sid=<?php echo $sid?>" class="jJ_UGsU2MxEp9-XuX_b7U-style-item">
                                        <span class="ng-binding">添加菜品</span>
...
<script>
    ...
    var sum = <?php echo count($commoditys_info); $i=0;?>;
    var CommodityInfo = <?php echo json_encode($commoditys_info)?>;
    for (var i=0;i<sum;i++)
    {
        ...
        c.setAttributeNode(add("ng-href","/CommodityInfo?sid=<?php echo $sid?>"));
        c.setAttributeNode(add("href","/CommodityInfo?sid=<?php echo $sid?>&cid="+CommodityInfo[i]['cid']));
        c.setAttributeNode(add("class","jJ_UGsU2MxEp9-XuX_b7U-style-item"));

        var d = document.createElement("span");
        d.setAttributeNode(add("class","ng-binding"));
        var node=document.createTextNode(CommodityInfo[i]['cname']+'  '+CommodityInfo[i]['price']);
        d.appendChild(node);
