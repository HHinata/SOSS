          ...
          <font style="vertical-align: inherit;">
            ...
            <span>
              ...
              <font style="vertical-align: inherit;">
                ...
                <!-- react-text: 11 -->
              <font style="vertical-align: inherit;">
                <font style="vertical-align: inherit;">请先登录</font></font>
                <!-- /react-text --></span>
          </span>
                </div>
            </header>
            <div class="Login__block___FHANx">
                ...
                <span class="Input__labelText___3690B">
                  <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;">手机号码</font></font>
                </span>
                        ...
                        <div class="Input__inputGroup___2_TNL" style="text-align: center;">
                            <div class="Input__inputButtonGroup___MuHZ3">
                                <label class="Input__label___1zkjm">
                                    <font style="vertical-align: inherit;">
                                        <font style="vertical-align: inherit;">
                                            <input type="button"  onclick="login()" class="Input__buttonInput___2tH_z Input__isPrimary___31SHE Input__isBig___1ESLM" value="登录"></font>
                                    </font>
                                </label>
                            </div>
                        </div>
...
<script>
    function login() {
        document.loginForm.action = "welcome?date=0";
