    ...
    <div class="_3_ezOQfol5ICPsaEsgqgEI-style-container mc-animation-fade" mc-nav-directive="">
      ...
      overflow: isOpen ? 'visible' : 'hidden'
            ...
            [styles.active]: meal === ctrl.meal.current
                                        ...
                                        <a ng-href="<?php echo $onclick_url[0]?>" ng-class="styles.link" href="<?php echo $onclick_url[0]?>" class="_1FtPiX9ThRadyw-1Pi_FkT-style-link">
                                            <span class="_YvHHUKePRPNyHOMAZBY_-style-targetTime"></span>
                                            <div class="_2cvy9glTa02FB4VfYHx2LY-style-name"><?php echo $group_info['gname']?></div>
            ...
            [styles.pressed]: pressBatch
              ...
              'icon-waiter_icon_pressed': actionMenuCtrl.isOn()
               ...
               [styles.pressed]: pressNotification
                ...
                <div ng-class="styles.user"  onclick="window.location.href='UserInfo?uid=<?php echo $uid?>&usertype=3';" class="_2aFVDIPMLKYnkv0x2vi3dW-style-user">
    ...
    <div class="_1KNiA28qlRm4LucsDNab0Z-style-restSection mc-animation-fade" mc-re-directive="">
        ...
        <div class="_37iJcSDIbh5G-vvTkAaGZu-style-header js-fixed">
            ...
            <div class="_2J_4A2wKM94FvRGZ6HNej-style-mealTitle" ng-if="!ctrl.isSearchFormOn">
                <h3 class="ng-binding"><?php echo $date[0]?></h3>
                <span class="_3r-TbkQw68v7mdhVe01ZSX-style-corpName"><?php echo $group_info['gname']?></span>
    ...
    <div ng-class="styles.container" mc-dish-directive="" ng-if="ctrl.isShowDish" class="ng-scope _1po2JRN2PMhBYoDFMakreW-style-container" id="three_list">
        ...
        <div class="_3kfuIgYLEKNcaG73pZkDlk-style-header" mc-section-head="" status="ctrl.status">
            ...
            <div class="_3xfp6SHIapi2SZOEh0R8t3-style-restName mc-animation-fade" ng-if="ctrl.dish.restaurant.name" style="opacity: 1;">
                <span class="f19zmoxFFn21rJGNW9mFY-style-restNameText"><?php echo $group_info['gname']?></span>
...
<script>
    function three_list_mark(three_list_flag) {
        ...
        f.setAttributeNode(add("onclick","window.location.href='EditCommodity?uid=<?php echo $uid?>&usertype=3&cid=';"));
        ...
        f1.setAttributeNode(add("onclick","window.location.href='DeleteCommodity?uid=<?php echo $uid?>&usertype=3&cid=';"));
        ...
        if(three_list_flag == 1) {
            f2.setAttributeNode(add("onclick","window.location.href='OffCommodity?uid=<?php echo $uid?>&usertype=3&cid=';"));
            f2.appendChild(node2);
        }else{
            f2.setAttributeNode(add("onclick","window.location.href='OnCommodity?uid=<?php echo $uid?>&usertype=3&cid=';"));
    ...
    function three_list_user_mark(uid) {
        var a = document.createElement("div");
        a.setAttributeNode(add("ng-if", "!ctrl.isLoading"));
        a.setAttributeNode(add("class", "_2ABZZGf8ZDa_pczpgG-EPp-style-cartWrapper"));
        ...
        f.setAttributeNode(add("class", "ng-scope"));
        f.setAttributeNode(add("ng-if","!ctrl.isOrdering"));
        f.setAttributeNode(add("onclick","window.location.href='<?php echo $onclick_url[6]?>';"));
        var node = document.createTextNode('修改');
        f.appendChild(node);
        ...
        f1.setAttributeNode(add("class", "ng-scope"));
        f1.setAttributeNode(add("ng-if","!ctrl.isOrdering"));
        f1.setAttributeNode(add("onclick","window.location.href='<?php echo $onclick_url[5]?>';"));
        var node1 = document.createTextNode('删除');
        f1.appendChild(node1);
    ...
    function chakanyuangong() {
        var a = document.createElement("li");
        a.setAttributeNode(add("ng-if", "ctrl.currentMeal.order"));
        a.setAttributeNode(add("class", "F9ey8JgI2IoqPcogOQFwt-style-rest mc-animation-slide <?php echo $ckygxz?>"));
        ...
        b.setAttributeNode(add("href", "<?php echo $onclick_url[3]?>"));


        var c = document.createElement("div");
        c.setAttributeNode(add("class", "_3uNy7RgCOUcfFu6au1W54_-style-restInner"));
        var d = document.createElement("span");
        var node = document.createTextNode('查看员工');
        d.appendChild(node);
    ...
    function chakandingdan() {
        ...
        var b = document.createElement("a");
        b.setAttributeNode(add("ng-href", "!ctrl.e.isMobile"));
        b.setAttributeNode(add("href", "/Welcome?flag=1&date=<?php echo $date_num?>&uid=<?php echo $uid?>&usertype=3&orderflag=1"));
    ...
    function addGroupUser() {
        ...
        var b = document.createElement("a");
        b.setAttributeNode(add("ng-href", "!ctrl.e.isMobile"));
        b.setAttributeNode(add("href", "<?php echo $onclick_url[1]?>"));
        ...
        var d = document.createElement("span");
        var node = document.createTextNode('添加员工');
        d.appendChild(node);
    ...
    function buildShop(shop,num) {
        ...
        var b = document.createElement("a");
        b.setAttributeNode(add("ng-href", "<?php echo $onclick_url[2]?>&shopflag="+num));
        b.setAttributeNode(add("href", "<?php echo $onclick_url[2]?>&shopflag="+num));
    ...
    function buildCommodity(commodity,num)
    {
      ...
      //  c.setAttributeNode(add("onclick","window.location.href='';"));
    ...
    function buildOrder(order,num)
    {
        ...
        var m = document.createElement("div");
        m.setAttributeNode(add("class", "_1HwOunLJd2-n_KC65PCLQ1-style-dishSubtitle"));
        var node2 = document.createTextNode(order['uname_phone']);
        m.appendChild(node2);
        var n = document.createElement("div");
        n.setAttributeNode(add("class", "_2E1I0DVW20nub3sewfo33b-style-dishFav ng-hide"));
        n.setAttributeNode(add("ng-show", "ctrl.checkFavourite(restaurant.id, dish)"));
    ...
    function buildUser(user,num)
    {
        ...
        a.setAttributeNode(add("ng-if", "dish.name"));
        a.setAttributeNode(add("ng-repeat", "dish in section.dishes track by $index"));
        a.setAttributeNode(add("class", "ng-scope _16JFh_4mqlSffOpyj-kpiZ-style-dish "+user['huise']+' '+user['xuanzhong']));
        ...
        c.setAttributeNode(add("onclick", "window.location.href='<?php echo $onclick_url[4]?>" + num + "';"));
        ...
        var l = document.createElement("div");
        l.setAttributeNode(add("class", "k830dcw3hnfrFruRRJShf-style-dishTitle"));
        var node1 = document.createTextNode(user['uname']);
        l.appendChild(node1);
        var m = document.createElement("div");
        m.setAttributeNode(add("class", "_1HwOunLJd2-n_KC65PCLQ1-style-dishSubtitle"));
        var node2 = document.createTextNode(user['phone']+"·····"+user['sex']);
        m.appendChild(node2);
        var n = document.createElement("div");
        n.setAttributeNode(add("class", "_2E1I0DVW20nub3sewfo33b-style-dishFav ng-hide"));
        n.setAttributeNode(add("ng-show", "ctrl.checkFavourite(restaurant.id, dish)"));
    ...
    var shop_sum = <?php echo count($shops_info)?>;
    var shops = <?php echo json_encode($shops_info)?>;
    for (var i=0;i<shop_sum;i++)
    {
        buildShop(shops[i],i);
    }
    ...
    var user_sum = <?php echo count($staffs_info)?>;
    var users = <?php echo json_encode($staffs_info)?>;
    for(var i = 0 ; i < user_sum ; i ++){
        buildUser(users[i],i);
    }
    ...
    var three_list_user_flag = <?php echo $three_list_user_mark?>;
    if(three_list_user_flag != -1){
        three_list_user_mark(users[three_list_user_flag]['uid']);
    }
</script>
</body></html>