    ...
    <div ng-class="styles.inner" class="_3Hwu_2GSDIciwZ-e4opE4y-style-inner" style="margin-top: 0px;">
        <div ng-class="styles.header" ng-show="title" class="_3_wSuLB2xzf6CLU1pfE3Z1-style-header">
            <div ng-class="styles.headerInner" class="ward56HhCdk0GZ-1MTcvO-style-headerInner">
                <span ng-class="styles.title" class="ng-binding">企业信息</span>
            </div>
        </div>
                    ...
                    <div ng-class="styles.container" mc-click="$event.stopPropagation()" class="_2zr0iYIKVbpdSwEMCUn83Q-style-container">
                        <div ng-class="styles.inner" class="_1Pe7GdQbdUNvrHqqjaEkWP-style-inner">
                            ...
                            <div ng-class="styles.group" class="_2UigEaYqg_TEE1K979TvOl-style-group">
                                ...
                                <a ng-class="styles.item" class="jJ_UGsU2MxEp9-XuX_b7U-style-item"><?php echo $group_info['phone']?></a>
                            </div>
                            <div ng-class="styles.group" class="_2UigEaYqg_TEE1K979TvOl-style-group">
                                <div ng-class="styles.title" class="_2qB5iACcWxNybtA6D2bYR7-style-title">地址</div>
                                <a ng-class="styles.item" class="jJ_UGsU2MxEp9-XuX_b7U-style-item"><?php echo $group_info['address']?></a>
                            </div>
                            <div ng-class="styles.group" class="_2UigEaYqg_TEE1K979TvOl-style-group">
                                <div ng-class="styles.title" class="_2qB5iACcWxNybtA6D2bYR7-style-title">企业用户</div>
                                <div mc-modal-me-item="" text="查看和修改" on-click-item="ctrl.openModalBinding" href="/UserList?flag=1&gid=<?php echo $group_info['gid']?>" class="ng-isolate-scope">
                                    <a ng-class="styles.item" mc-click="onClick($event)" ng-href="" href="/UserList?flag=1&gid=<?php echo $group_info['gid']?>" class="jJ_UGsU2MxEp9-XuX_b7U-style-item">
                            ...
                            <div ng-class="styles.group" class="_2UigEaYqg_TEE1K979TvOl-style-group">
                                <div ng-class="styles.title" class="_2qB5iACcWxNybtA6D2bYR7-style-title">合作餐厅</div>
                                <div mc-modal-me-item="" text="查看和修改" href="/ShopList?flag=1&gid=<?php echo $group_info['gid']?>" on-click-item="ctrl.openModalBinding" class="ng-isolate-scope">
                                    <a ng-class="styles.item"  ng-href="" href="/ShopList?flag=1&gid=<?php echo $group_info['gid']?>" class="jJ_UGsU2MxEp9-XuX_b7U-style-item">
                                        <span class="ng-binding">查看和修改</span>
                                        <i ng-class="['icon',  customClass, iconClass]" mc-icon="" class-name="_2zn6BlloQejehRAwde1wBE-style-icon" which="arrow-right-digital-card" class="ng-isolate-scope icon  icon-arrow-right-digital-card _2zn6BlloQejehRAwde1wBE-style-icon"></i>
                                    </a>
                                </div>
                            ...
                            <div ng-class="styles.group" class="_2UigEaYqg_TEE1K979TvOl-style-group">
                                ...
                                <div ng-if="!ctrl.e.isMobile" mc-modal-me-item="" text="修改信息" href="/EditGroupInfo<?php echo $group_info['gid']?>" class="ng-scope ng-isolate-scope">
                                    <a ng-class="styles.item" ng-href="/EditGroupInfo?flag=1" href="/EditGroupInfo?gid=<?php echo $group_info['gid']?>" class="jJ_UGsU2MxEp9-XuX_b7U-style-item">
